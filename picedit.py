...
def magic_wand_select(image, x, thres):
    ...
    # Create a list to store the coordinates that have 
    # already been checked to prevent double-checking
    checked = [x]
    ...
    while tbc:
            ...
            if (i,c) not in checked and 0 <= i < row:
                # Check top pixel
            ...
            # and it does not exceed size of image, proceed to calculate         
            if (r,k) not in checked and 0 <= k < col:
                # Check right pixel
            ...
            # and it does not exceed size of image, proceed to calculate         
            if (r,l) not in checked and 0 <= l < col:
                # Check left pixel
...
def menu():
    ...
    # While image hasn't been loaded, prompt user for action
    while img.size == 0:
    ...
    while img.size > 0 and count > 0:
            ...
            while True:
                ...
                try:
                    ...
                    if filename.lower()[-4:] == ".jpg" or filename.lower()[-4:] == ".png":
                      ...
                      masked_img = img.copy()
                      break
                except FileNotFoundError: #doesnt catch error
        ...
        # Rectangle select    
            ...
            while True: #outer
                    ...
                    try:
                        while True: #inner 
                            xx = int(input("Enter row value of top left pixel position:"))
            ...
            while True: #outer
                ...
                try:
                    while True: #inner
                        xy = int(input("Enter column value of top left pixel position:"))
                        # If exceeds img dimensions, prompt again
                        if xy < 0 or xy > col:
            ...
            while True: #outer
                ...
                try:
                    while True: #inner
                        yx = int(input("Enter row value of bottom right pixel position:"))
                        # If exceeds img dimensions, prompt again
                        if yx < 0 or yx > row or yx < xx:
                            print(f"Please enter a value within 0 to {row} and larger than {xx}")
                            continue #with inner while loop
                        else:
                            break #out of inner while loop
                except (ValueError or TypeError):
            ...
            while True: #outer
                ...
                try: 
                    while True: #inner
                        yy = int(input("Enter column value of bottom right pixel position:"))
                        # If exceeds img dimensions, prompt again
                        if yy < 0 or yy > col or yy < xy:
                            print(f"Please enter a value within 0 to {col} and larger than {xy}")
                            continue #with inner while loop
                        else:
                            break #out of inner while loop
                except (ValueError or TypeError):
        ...
        # Magic wand selection        
            ...
            while True:
                try:
                    thres = float(input("Enter an appropriate thres value:"))
                except (ValueError or TypeError or UnboundLocalError):
                    print("Enter an integer or decimal value for thres (a common value for thres is 300):")
                    continue #with outer while loop
                finally:
                    break #out of outer while loop
